...
@section('content')
    <div class="border m-4 p-3 rounded overflow-auto">
        ...
        <table class="table mt-4 table-bordered">
            <tr>
                <td colspan="3" class="bg-blue" style="border-top-left-radius: 1rem;"></td>
            ...
            <tr>
                ...
                <td class="bg-blue text-center text-white"><small>Aksi</small></td>
            ...
            <tr>
                <td class="text-center"><small><button class="btn btn-sm btn-warning text-white mr-1 mb-1 mb-md-0">Edit</button><button class="btn btn-sm btn-info">Read</button></small></td>
            ...
            <tr>
                <td class="text-center" style="border-top-left-radius: 1rem;"><small>1800018023</small></td>
                <td class="text-center"><small>Ronald Richards</small></td>
                <td class="text-center"><small>C</small></td>
                <td class="text-center"><small>50</small></td>
                <td class="text-center"><small>50</small></td>
